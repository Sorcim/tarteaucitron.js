...
tarteaucitron.services.googlemaps = {
    ...
    "js": function () {
        ...
        tarteaucitron.addScript('//maps.googleapis.com/maps/api/js?v=3.exp&key='+tarteaucitron.user.googlemapsAPI+'&callback=tac_googlemaps_callback');

        window.tac_googlemaps_callback = function () {
            tarteaucitron.fallback(['googlemaps-canvas'], function (x) {
                var uniqId = '_' + Math.random().toString(36).substr(2, 9);
                uniqIds.push(uniqId);
                return '<div id="' + uniqId + '" zoom="' + x.getAttribute('zoom') + '" latitude="' + x.getAttribute('latitude') + '" longitude="' + x.getAttribute('longitude') + '" style="width:' + x.offsetWidth + 'px;height:' + x.offsetHeight + 'px" markers=\''+x.getAttribute('markers')+'\' stylemap=\''+x.getAttribute('stylemap')+'\'></div>';
            });
            ...
            for (i = 0; i < uniqIds.length; i += 1) {
                ...
                mapOptions = {
                    ...
                    styles: JSON.parse(document.getElementById(uniqIds[i]).getAttribute('stylemap'))
                };
